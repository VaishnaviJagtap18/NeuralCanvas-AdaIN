...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='D:/NST_CODE/content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='D:/NST_CODE/style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='D:/NST_CODE/vgg_normalised.pth',
